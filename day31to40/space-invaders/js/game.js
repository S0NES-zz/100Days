...
const playerMaxSpeed = 400.0;
const laserMaxSpeed = 300.0;
const laserCooldown = 0.5;
const player_src = "img/player_C.png";


const laserPlayerSrc = "img/laser-player.png";
const laserEnemySrc = "img/laser-enemy.png";

const enemySrc = "img/enemy_a.png";
...
function init() {
  ...
  const enemySpacing =
    (gameWidth - enemyHorizontalPadding * 2) / (enemiesPerRow - 1);
  for (let j = 0; j < 3; j++) {
